...
const SignIn = () => {
  ...
  return (
    <>
      <div className="flex items-center h-full justify-center rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="inline-block" to="/">
                <img className="block w-[140px] mb-8" src={Logo} alt="Logo" />
              </Link>
                  ...
                  <Form>
                    ...
                    <div className="mb-6">
                      ...
                      {errors.password && touched.password ? (
                        <div className="text-meta-1">{errors.password}</div>
                      ) : null}
                    </div>
