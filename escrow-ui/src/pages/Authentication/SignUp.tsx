...
const SignUp = () => {
  ...
  return (
    <>
      <div className="h-full flex justify-center items-center rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img
                  className="dark:hidden w-[140px] mb-8"
                  src={Logo}
                  alt="Logo"
                />
              </Link>
                  ...
                  <Form>
                    <div className="mb-4">
                      ...
                      {errors.name && touched.name ? (
                        <div className=" text-meta-1">{errors.name}</div>
                      ) : null}
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      {errors.email && touched.email ? (
                        <span className=" text-meta-1 break-words">
                          {errors.email}
                        </span>
                      ) : null}
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      {errors.password && touched.password ? (
                        <div className=" text-meta-1 break-words">
                          {errors.password}
                        </div>
                      ) : null}
                    </div>
